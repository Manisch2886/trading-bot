#!/bin/bash
# TB-107 G2: die 8 Ausgaben ohne Modus (g2_ausgaben.sh) nachher, Vergleich gegen den Vorher-Lauf, dazu der
# Benchmark ohne Modus. Aufruf aus der Repo-Wurzel: bash docs/belege/TB-107/g2_gesamt.sh <scratch>
set -u
SP="$1"
unset TB_SELEKTIONSWURZEL TB_SELEKTIONSHASH TB_SELEKTIONSCOMMIT
bash docs/belege/TB-107/g2_ausgaben.sh "$SP/g2_nachher"
echo "## Vergleich gegen g2_vorher (Code-Stand f22f91e, 0b)"
