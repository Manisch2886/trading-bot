"""TB-110 D2: jedes eingesetzte Fable-Zitat im Register gegen seine Quelle (diff).
...
Aufruf aus der Repo-Wurzel; TB110_PROBE=<pfad> prueft eine Kopie.
"""
import json
import os
import subprocess
...
zitate = json.load(open("docs/belege/TB-110/zitate.json", encoding="utf-8"))
BEREICH = {"Abschnitt 43": (next(i for i, r in enumerate(reg) if r.startswith("## 43. ")), len(reg))}
