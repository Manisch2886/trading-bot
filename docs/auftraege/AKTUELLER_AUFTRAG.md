...
|---|---|---|
| **TB-89** | `docs/auftraege/MAC_TB-89_register_38.md` | ⭐⭐ **Registerabschnitt 38 — Fables vier Entscheidungen aus 22h plus die Messungen aus TB-88.** ⛔⛔ **NUR TEXT: keine `.py`, kein neues Modul, kein Import, kein Abbild, kein Vollzug, keine Sonde.** Weg (A) — die letzte Falte heisst die Spanne (38.1) · Fundstellen als Datei und Bezeichner, Zeilennummern nur mit Commit (38.2) · Vollzug von Punkt 4 nach **37.3**, kein Amendment, kein Protokoll (38.3) · Sperrlistenpunkt 4 bekommt **Form (ii)**, Vollzug steht aus (38.4) · ⭐ **kein Laufmodul traegt eine eigene Kostenkopie** — neun Importe statt Ueberwachung; Punkt 7 hat seinen Ort schon (38.5) · Fables Ersatzsatz fuer 37.4, acht statt fuenf Stellen (38.6) · Tatsachennotizen aus TB-88, darunter ⚠️ **dass der Test heute abstuerzt und nach dem Vollzug 163/2 bleibt — als OFFENE FRAGE eintragen, nicht beantworten** (38.7). Alle Blockzitate zeichengleich aus `FABLE_ANTWORT_2026-09-22h_…`, Zeichenvergleich je Zitat. numstat zweite Spalte `0`, drei Hashes vorher UND nachher |

*Gesetzt 22.09.2026 (zuvor TB-88, erledigt mit `ec54618`, 22.09.2026; davor TB-87 `afe6192`, TB-86 `ee4e65c`;
