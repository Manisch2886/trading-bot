# Registerkopie für Fable 5.1 — Stand 24.09.2026, 23:00 Ortszeit

⚠️ **Diese Datei ist eine KOPIE.** Die Quelle ist
`docs/VORREGISTRIERUNG_neuselektion.md` im Repo; bei jeder Abweichung gilt die
Quelle, nicht diese Kopie.

**Sie ersetzt `REGISTER_KOPIE_2026-09-22.md`** (Commit `61c52a0`, Abschnitte
0–36). ⚠️⚠️ **Jene Kopie war zwei Tage alt und es fehlten ihr die Abschnitte
37 bis 40** — also genau die, auf denen die Antworten 23a bis 24c aufbauen.

| | |
|---|---|
| **Commit des Registers** | `d0dc890` (24.09.2026, 09:21:40 +0200) |
| **Repo-HEAD beim Kopieren** | `d05e3ff` |
| **SHA-256 der Quelle** | `10ffa7b3a7b0652e8f9da0eedac1af5cb82ae045317a3d05118de6568c5092aa` |
| **Zeilen / Bytes** | 7993 / 549 972 |
| **Abschnitte** | **0 bis 40** — lückenlos |

⭐ **Neu gegenüber der Kopie vom 22.09.:** **1809 Zeilen, null entfernt**
(`git diff --numstat 61c52a0 d0dc890` ⇒ `1809  0`). Die append-only-Eigenschaft
ist damit für diesen Zeitraum gemessen, nicht behauptet.

**Die vier neuen Abschnitte:**

| | |
|---|---|
| **37** | Die Sonde meldet je Bestandteil, das Abbild führt zwei Gruppen, was ein Befund `1` bedeutet, hängt vom Tag ab, und der **Ort registrierter Werte** (Fable 22d und 22g, TB-87) |
| **38** | Weg (A) — die letzte Falte heisst die Spanne, Fundstellen als Datei und Bezeichner, der **Vollzug von Punkt 4 nach 37.3 in Form (ii)**, neun Importe statt überwachter Kostenkopien, zwei Berichtigungen des Verfahrensprüfers an sich selbst (Fable 22h, TB-89) |
| **39** | **Der Vollzug von Sperrlistenpunkt 4 im Register** — Berichtigung des Fertigkriteriums in 38.4, Form (ii) vollzogen, Determinismus- und Modus-Nachweis, fünf Hash-Übergänge nach 37.3, **zwei Eingaben ohne registrierten Eingabestand** und das neue Abbild (Fable 23a–23f, TB-94) |
| **40** | **Testannahmen folgen dem Register, und die neun Handelslisten sind Eingabedateien** — `G6`/`H3`, die Kopplung an 5.1 Nr. 4, jede Mutationsprobe mit Gegenprobe, was TB-97/TB-98 tun (Fable 24a, TB-96) |

⚠️ **Nach 27.3 darfst du das Register vollständig lesen** — was darin steht, hat
das Tor aus 27.1 bereits passiert.
