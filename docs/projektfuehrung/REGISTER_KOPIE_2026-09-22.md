# Registerkopie für Fable 5.1 — Stand 22.09.2026, 18:00 Ortszeit
...
**Sie ersetzt `REGISTER_KOPIE_2026-09-21.md`** (Commit `2250ed1`, Abschnitte
1–31), die Fable in 22b selbst als zu alt gemeldet hat.

| | |
|---|---|
| **Commit des Registers** | `61c52a0` (22.09.2026, 08:04:35 +0200) |
| **Repo-HEAD beim Kopieren** | `df2562e` |
| **SHA-256 der Quelle** | `e6d3865b6940e9c82861b7b05ceeef3e2de10ebaae34c7f2f9eb6db3802089d4` |
| **Zeilen / Bytes** | 6184 / 399 293 |
| **Abschnitte** | **0 bis 36** — lückenlos |

⭐ **Neu gegenüber der Kopie vom 21.09.** (dort endete sie bei Abschnitt 31):
**1095 Zeilen, null entfernt.** Die Abschnitte **32** (Bedingung (i) auf `asof`),
**33** (Faltenplan als Registertext und Feldliste), **34** (Falten mit Länge > 1,
Rest vor Go-Live, `3b (a)`, `horizontbeginn`, „vier"→„neun"), **35**
(Bestätigungsperiode und Sondenzeitpunkt) und **36** (Schreibregel für
Sperrlistenpfade, Sperrlisten-Sonde, drei Ausgänge, Abbild der Sperrliste) sind
vollständig enthalten — also alles, was aus Fables eigenen Antworten
21i bis 22c entstanden ist.

⭐ **Sichtschutz (Registerabschnitt 27) unberührt:** Das Register enthält
keine Ergebnisgrößen des Selektionsraums; es ist ihm nach 27.3 ausdrücklich
ganz zugänglich.
