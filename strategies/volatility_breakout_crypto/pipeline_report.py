"""
Vollstaendiger Pipeline-Report: Volatility-Breakout-Krypto-Prototyp
==================================================================
Analog zu volatility_breakout/pipeline_report.py: Equity-Simulation
...
def collect_trades_windowed(windowed_data: dict, stop_loss_pct: float = None,
