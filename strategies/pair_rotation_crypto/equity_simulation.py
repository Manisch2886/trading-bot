"""
Phase 3 - Equity-Kurven-Simulation (realistisches Portfolio): Pair-Rotation (Krypto)
================================================================================================
Identisches Prinzip wie bei den anderen Bots. Startwerte wie angefragt:
10% Allokation, Limit 8. WICHTIG - siehe PROTOTYPE_FINDINGS.md Abschnitt 3:
die hier als "validierte Basiskonfiguration" gefuehrte Kombination ist nur
die GESAMTZEITRAUM-beste - der Walk-Forward-Test zeigt, dass praktisch
JEDE getestete Kombination Out-of-Sample scheitert (siehe dort). Diese
Equity-Simulation dient der vollstaendigen, mit den anderen Prototypen
vergleichbaren Pipeline-Dokumentation, ist aber NICHT als validierter
Kandidat zu verstehen.
"""
...
# Gesamtzeitraum-bester Score aus multi_pair_optimise.py - NICHT Out-of-Sample-validiert, siehe Modul-Docstring
LOOKBACK_DAYS = 120
REBALANCE_DAYS = 5
STOP_LOSS_PCT = None


def collect_all_trades(pairs: list, lookback_days: int, rebalance_days: int,
...
if __name__ == "__main__":
    ...
    print(f"{len(trades)} Trades ueber alle Paare gefunden.\n")
