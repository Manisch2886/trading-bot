"""
Phase 2 - Multi-Pair Walk-Forward-Validierung: Pair-Rotation (Krypto)
================================================================================
Analog zu pair_rotation_stocks/multi_pair_walk_forward.py. Split-Punkt
korrekt INNERHALB des Auswertungsfensters (ab get_reference_date, siehe
multi_pair_optimise.py) berechnet.
"""
...
if __name__ == "__main__":
    ...
    print(f"{len(pairs)} Paare entdeckt (identisch fuer IS und OOS).\n")
