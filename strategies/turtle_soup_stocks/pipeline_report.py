"""
Vollstaendiger Pipeline-Report: Turtle Soup (Aktien)
==================================================================
Analog zu den anderen Bots: Equity-Simulation (Gesamtzeitraum UND
Out-of-Sample) fuer die validierte Kombination, plus Buy-and-Hold-Vergleich.
"""
