"""
Phase 2 - Multi-Symbol Walk-Forward-Validierung: Turtle Soup (Aktien)
==========================================================================
Analog zu rsi2_mean_reversion/multi_symbol_walk_forward.py: Split-Punkt
korrekt INNERHALB des RECENT_YEARS_ONLY-Auswertungsfensters berechnet.
"""
...
def evaluate_combination_multi_windowed(windowed_data: dict, donchian_period: int, stop_mode=None) -> dict:
    ...
    for symbol, (df_ind, cutoff_start, cutoff_end) in windowed_data.items():
        trades = get_trades_for_symbol(df_ind, cutoff_start, donchian_period, stop_mode)
