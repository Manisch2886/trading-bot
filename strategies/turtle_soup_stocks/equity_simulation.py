...
# Wie beim Krypto-Zwilling: `setup_day_low` ist ein Kursniveau, kein Mass
# fuer Signalstaerke. Eine Rangregel darauf sortierte nach Notierungshoehe
# und verfehlte Eigenschaft 3 (skalenfrei). Kein Primaerschluessel.
SIGNALSPALTE = None
