...
================================
Liest dieselbe Top-150-Liste wie elliott_wave_stocks aus
config/sp500_top150.txt - identisches Universum, fuer einen fairen
Diversifikations-Vergleich zwischen den beiden Aktien-Bots. Faellt auf
eine kleine Standardliste zurueck, falls die Datei noch nicht existiert.
"""
