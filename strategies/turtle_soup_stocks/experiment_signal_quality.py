"""
Turtle Soup (Aktien): Signal-Qualitaets-Test (analog zu RSI-2/Volatility Breakout)
================================================================================
Trennt Timing-/Signal-Nutzen von Kapitalmanagement-Nutzen - identische
Methodik wie volatility_breakout/experiment_signal_quality.py. Vergleicht:
...
Ziel: pruefen, ob die ungewoehnlich hohe Aktien-Skip-Rate (84,4% bei
Limit 8/10% Allokation) rein auf Kapitalmanagement zurueckzufuehren ist
(wie bei den anderen Bots), oder ob etwas anderes mitspielt (z.B. eine
systematisch schlechtere Signalqualitaet bei den uebersprungenen Trades).
