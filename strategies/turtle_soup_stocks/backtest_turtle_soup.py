"""
Backtest-Engine: Turtle Soup (False-Breakout-Reversal, nach Linda Raschke/Larry Williams)
========================================================================================================
Long-only, Aktien, Tagesbasis. Scannt taeglich (kein mehrtaegiges
Freshness-Fenster noetig, siehe Punkt 2) - identisches Grundmuster zu
RSI-2/Volatility Breakout: State-Automat pro Symbol auf NumPy-Arrays
