"""
Kapitalmanagement-Tuning: Positionsgroesse x Positionslimit fuer Turtle Soup (Aktien)
================================================================================
Analog zu rsi2_mean_reversion/experiment_position_size_limit.py und
volatility_breakout/experiment_position_size_limit.py. Ausgangslage: 84,4%
Skip-Rate bei Limit 8/10% Allokation - der staerkste bisher beobachtete
Kapital-Flaschenhals im gesamten Projekt (siehe
results/turtle_soup_stocks/PROTOTYPE_FINDINGS.md Abschnitt 4).

Feste Basis (nicht Teil des Grids): Donchian 10, kein Stop, 10 Tage
Zeit-Exit - die validierte Gesamtzeitraum-beste Kombination aus
multi_symbol_optimise.py. Testet Allokation {10%,5%,3%,2%} x Limit
{8,15,20,unbegrenzt}, Gesamtzeitraum UND Out-of-Sample.
"""
...
if __name__ == "__main__":
    print(f"Feste Parameter: Donchian {DONCHIAN_PERIOD} | Stop: "
          f"{'kein Stop' if STOP_MODE is None else STOP_MODE} | Zeit-Exit: 10 Tage\n")
