"""
Abschliessende Zusammenfassung: Kapitalmanagement-Tuning Turtle Soup (Aktien)
================================================================================
Kombiniert experiment_position_size_limit.py (Gesamtzeitraum + OOS-Rendite/DD
je Konfiguration) mit einer Stress-Perioden-Auswertung (2022 UND 2020) FUER
JEDE Konfiguration des Grids (Allokation {10%,5%,3%,2%} x Limit
{8,15,20,unbegrenzt}, feste Basis Donchian 10/kein Stop/10-Tage-Zeit-Exit).
Eine Zeile je Konfiguration, sortiert nach Out-of-Sample-Rendite absteigend -
Grundlage fuer eine spaetere Live-Entscheidung.
"""
...
def evaluate_config(trades_full: pd.DataFrame, trades_oos: pd.DataFrame,
    ...
    stress_2022 = evaluate_window(curve_full, *STRESS_PERIODS["2022"])
    stress_2020 = evaluate_window(curve_full, *STRESS_PERIODS["2020"])
    ...
    return {
        ...
        "2020_rendite_pct": stress_2020["rendite_pct"], "2020_max_dd_pct": stress_2020["max_dd_pct"],
    }
...
if __name__ == "__main__":
    ...
    print("=" * 140)
    print("KAPITALMANAGEMENT-TUNING TURTLE SOUP (AKTIEN) - GESAMTUEBERSICHT, SORTIERT NACH OOS-RENDITE")
    print("Basis: Donchian 10, kein Stop, 10-Tage-Zeit-Exit")
    print("=" * 140)
