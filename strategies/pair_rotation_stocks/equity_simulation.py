"""
Phase 3 - Equity-Kurven-Simulation (realistisches Portfolio): Pair-Rotation (Aktien)
================================================================================================
Identisches Prinzip wie bei den anderen Bots: event-basierte Simulation
mit festem Startkapital, prozentualer Positionsgroesse und Positionslimit.
Jedes Paar liefert zu jedem Zeitpunkt hoechstens EINE offene Position
(entweder im staerkeren Asset A oder B) - "Symbol" im Trades-DataFrame ist
das jeweils gehaltene Einzel-Asset, das Limit wirkt uebergreifend ueber
alle Paare hinweg (identisch zur Positionslimit-Logik der anderen Bots).
Startwerte wie angefragt: 10% Allokation, Limit 8.
"""
...
# Validierte Basiskonfiguration aus multi_pair_optimise.py (bester Gesamtzeitraum-Score)
LOOKBACK_DAYS = 120
REBALANCE_DAYS = 5
STOP_LOSS_PCT = 12.0
