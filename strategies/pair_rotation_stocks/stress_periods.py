...
================================================================================
Von Anfang an mitgedacht (wie beim Volatility-Breakout-Praezedenzfall):
wertet die validierte Basiskonfiguration in den beiden bekannten Stress-
Fenstern aus (Rendite, Max Drawdown je Fenster, plus Allzeit-Max-Drawdown
zum Vergleich - identisch zur bei den anderen Prototypen etablierten
Methodik).
"""
...
if __name__ == "__main__":
    ...
    print("=" * 90)
    print("STRESS-PERIODEN-VERGLEICH: Pair-Rotation (Aktien)")
    print("=" * 90)
