"""
Kapitalmanagement-Tuning: Positionsgroesse x Positionslimit fuer Turtle Soup (Krypto)
================================================================================
Analog zu turtle_soup_stocks/experiment_position_size_limit.py. Krypto zeigte
in der Prototyp-Phase nur eine moderate 11,6% Skip-Rate (Limit 8/10%
Allokation) - deutlich schwaecherer Flaschenhals als bei Aktien, wird hier
zur Vollstaendigkeit ermittelt.

Feste Basis (nicht Teil des Grids): Donchian 10, structural Stop, 10 Tage
Zeit-Exit - die validierte Gesamtzeitraum-beste Kombination aus
multi_symbol_optimise.py. Testet Allokation {10%,5%,3%} x Limit
{8,15,unbegrenzt}, Gesamtzeitraum UND Out-of-Sample.
"""
