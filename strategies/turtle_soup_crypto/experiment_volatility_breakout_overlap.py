"""
Abgrenzung zu Volatility Breakout Krypto: Signal-Ueberschneidung und Divergenz
================================================================================
Analog zu turtle_soup_stocks/experiment_volatility_breakout_overlap.py -
siehe dortigen Docstring fuer die vollstaendige Begruendung (Diversifikations-
these, Subprozess-Isolation wegen gleichnamiger Module). Vergleich gegen die
BASIS-Regel von Volatility Breakout Krypto (ohne BTC-Regime-Filter) - fuer
einen apples-to-apples-Vergleich der beiden False-Breakout-Signal-Logiken
selbst, ohne einen zusaetzlichen Filter auf nur einer Seite.
"""
...
_VB_DIR = os.path.join(_STRATEGIES_ROOT, "volatility_breakout_crypto")
