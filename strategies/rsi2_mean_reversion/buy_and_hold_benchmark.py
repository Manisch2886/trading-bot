"""
Buy-and-Hold-Vergleich: RSI-2 Mean-Reversion
==================================================
Gleiches Prinzip und (da identisches Universum/Zeitraum) im Kern identisches
Ergebnis wie beim bestehenden Elliott-Wave-Aktien-Bot - hier als eigene,
unabhaengige Kopie gehalten (Architektur-Prinzip: jede Strategie steht fuer
sich), nicht cross-strategy importiert. Nutzt RECENT_YEARS_ONLY wie
multi_symbol_optimise.py fuer einen fairen Zeitraum-Vergleich.
"""
...
from multi_symbol_optimise import RECENT_YEARS_ONLY, INTERVAL

STARTING_CAPITAL = 10_000.0


def load_recent_data() -> dict:
    data = {}
