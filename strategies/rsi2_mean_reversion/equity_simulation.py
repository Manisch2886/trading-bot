...
# Wie beim Krypto-Zwilling: der RSI(2) zum Einstieg ist die stetige
# Signalstaerke dieser Strategie, tiefer = ueberverkaufter = staerker,
# also AUFSTEIGEND. Die Richtung stammt aus der Strategielogik, nicht aus
# dem Backtest-Ergebnis.
#
# Eigenschaft 2 gemessen: 442 verschiedene Werte auf 5391 Trades, 2,1 % der
# gleichzeitigen Trades bleiben darauf gleichauf. Das ist knapp UEBER der
# 2-%-Marke der Pruefliste, und diese Zeile soll das nicht verschweigen: es
# ist eine Ermessensentscheidung, kein Bestehen. Sie faellt trotzdem fuer den
# Schluessel aus, weil die verbleibenden 2,1 % auf den Stufen 2 bis 4
# aufgeloest werden - genau dafuer ist die Regel eine Kaskade -, waehrend die
# uebrigen 97,9 % einen oekonomischen Grund bekommen, den sie sonst nicht
# haetten. Zum Vergleich: der `fib_score` der beiden Elliott-Bots bleibt bei
# 38,6 % bzw. 72,7 % gleichauf; dort waere es umgekehrt.
#
# Wer den Primaerschluessel nicht will, setzt hier None - eine Zeile, und die
# Kaskade beginnt fuer diesen Bot bei Stufe 2. Wirkung siehe
# docs/TB-26_ZUTEILUNGSKASKADE.md.
