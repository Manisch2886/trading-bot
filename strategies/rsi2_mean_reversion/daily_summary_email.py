"""
Phase 4b - Taegliche E-Mail-Zusammenfassung: RSI-2 Mean-Reversion (Aktien)
================================================================================
Analog zu elliott_wave_stocks/daily_summary_email.py. Liest die Bot-eigene
paper_trading-Datenbank aus und verschickt eine taegliche Zusammenfassung.
