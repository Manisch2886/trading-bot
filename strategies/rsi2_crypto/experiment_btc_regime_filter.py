"""
Experiment: BTC-Regime-Filter fuer RSI-2 Krypto (auf ausdrueckliche Anfrage)
================================================================================
Testet den beim T3/SuperTrend-Bot etablierten BTC-Regime-Filter
(regime_filter.py, taeglicher SuperTrend auf BTC/USDT) als zusaetzliche
Vorbedingung fuer RSI-2-Krypto-Einstiege: nur Einstiege, wenn BTC selbst in
einem eigenen Aufwaertstrend ist. Vergleich Basis-Regel (kein Filter) gegen
gefilterte Variante, Gesamtzeitraum UND Out-of-Sample.
"""
...
from equity_simulation import collect_all_trades, simulate_portfolio, calculate_max_drawdown, \
    STARTING_CAPITAL, ALLOCATION_PCT, MAX_CONCURRENT_POSITIONS, SMA_TREND_PERIOD, RSI_THRESHOLD, STOP_LOSS_PCT
...
if __name__ == "__main__":
    ...
    print("=" * 90)
    trades_no_filter = collect_all_trades(all_data, RSI_THRESHOLD, SMA_TREND_PERIOD, STOP_LOSS_PCT)
    ...
    print("OUT-OF-SAMPLE")
    print("=" * 90)
    trades_oos_no_filter = collect_trades_windowed(test_data, RSI_THRESHOLD, SMA_TREND_PERIOD, STOP_LOSS_PCT)
