"""
Buy-and-Hold-Vergleich: RSI-2 Mean-Reversion Krypto
=============================================================
Gleiches Prinzip wie bei den anderen Bots - eigenstaendige Kopie.
Nutzt dasselbe Krypto-Universum/denselben Zeitraum wie
multi_symbol_optimise.py (nur Symbole mit ausreichender Historie).
"""
