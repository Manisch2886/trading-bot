"""
Buy-and-Hold-Vergleich: Bollinger-Band-Squeeze-Breakout
=============================================================
Gleiches Prinzip wie bei den anderen Aktien-Bots - eigenstaendige Kopie
(Architektur-Prinzip). Nutzt RECENT_YEARS_ONLY wie multi_symbol_optimise.py
fuer einen fairen Zeitraum-Vergleich.
"""
